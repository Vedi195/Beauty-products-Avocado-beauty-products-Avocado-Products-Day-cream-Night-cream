...
const ContactFloat = () => {
  const callLink = getCallLink?.() || 'tel:+917096287029';
  const whatsappLink =
    getWhatsAppLink?.() || 'https://wa.me/917096287029';

  return (
    <div className="contactFloat" data-testid="contact-float">
      
      {/* Call Button */}
      <a
        href={callLink}
        className="floatBtn call"
      ...
      >
        ...
        <span className="btnText">Call Now</span>
      </a>
      ...
      <a
        ...
        data-tooltip="WhatsApp to Order"
      >
        <span className="icon">
        ...
        <span className="btnText">WhatsApp</span>
      </a>
