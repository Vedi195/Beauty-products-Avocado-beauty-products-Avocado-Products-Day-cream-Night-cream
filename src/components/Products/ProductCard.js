...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="productCard" data-testid={`product-card-${product.id}`}>
      ...
      <div className="imageContainer">
        ...
        <div className="badges">
          ...
          {product.isCombo && <span className="badge combo">🔗 Combo</span>}
          {product.isSpecial && !product.isCombo && (
      ...
      <div className="cardContent">
        ...
        <div className="rating">
          {!ratingLoading && averageRating > 0 ? (
            ...
            <span className="noRating">No ratings yet</span>
          )}
        </div>
        ...
        <div className="cardActions">
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.52 2 2 0 0 1 3.62 1.5h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9.09a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
            </svg>
          </a>
